...
// If we continue this square and triangle are two examples of subclasses of polygon.


// Polymorphism, virtual function
// It is a mechanism to define the same operation for different types of realization of a class.
